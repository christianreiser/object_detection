...
Example usage:
python eval.py --logtostderr --checkpoint_dir='./../samples/configs/training/models/' --eval_dir='eval/'  --eval_config_path=eval_config.pbtxt  --model_config_path=pipeline.config  --input_config_path=eval_input_config.pbtxt
"""
import functools
import os
